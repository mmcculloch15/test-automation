...
exports.config = {
	...
	user: process.env.BROWSERSTACK_USER, //these are loaded in by requiring dotenv at the top of this file
	...
	before: function(capabilities, specs) {
		...
		// browser.addCommand('setInputValue', (element, value) => {
		// 	if (browser.capabilities.browserName.includes('edge')) {
		// 		browser.elementSendKeys(element.elementId, value.split(''))
		// 	} else {
